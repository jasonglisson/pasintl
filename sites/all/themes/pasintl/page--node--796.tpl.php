...
<section class="" id="section-3">
		...
		<div class="visible-lg">
	  	...
	  	<div id="section-3-content-1" class="container">
			<?php
				$block = module_invoke('panels_mini', 'block_view', 'dui_d_detection');
				print $block['content'];
			?>					  	
</section>  
<section class="" id="section-4">
		...
		<div id="section-4-content-1" class="container">
			<br>
			<?php
				$block = module_invoke('panels_mini', 'block_view', 'data_management');
				print $block['content'];
			?>			
			<br>		  		  					  	  	  	  
	</section>   
	<section class="" id="section-5">
		<div class="container">  
			<div class="col-lg-12 col-md-12">
				<h2 class="micro-section-title" id="section5">
		...
		<div id="section-5-content-1" class="container">
			<br>
			<?php
				$block = module_invoke('panels_mini', 'block_view', 'oral_fluid_testing');
				print $block['content'];
			?>	
			<br>				  	
	  </div>		  	  	  		 	  	  
