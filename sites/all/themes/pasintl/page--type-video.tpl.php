...
<div class="main-container container">
  ...
  <div class="row">
	...
	<?php print render($title_prefix); ?>
		<?php if (!empty($title)): ?>
			<h1 class="page-header col-sm-12"><?php print $title; ?></h1>
		<?php endif; ?>
	<?php print render($title_suffix); ?>
	<?php 
		foreach ($node->field_blog_category['und'] as $val) { ?>
		  <h4 class="col-sm-12"><?php echo date( "F j, Y",$node->created); ?> - <?php print $val['taxonomy_term']->name; ?></h4>
	<?php } ?>
    ...
    <section class="col-lg-7 blog-main-col">
