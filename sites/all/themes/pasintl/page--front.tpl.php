...
<section class="front-header">
  ...
  <?php print render($page['content']); ?>
    ...
    <div class="blue-strip visible-md visible-lg"></div>
</section>
...
<div class="front-main-content">
  ...
  <div class="row main-content">
    ...
    <section id="homepage-text" class="">
    	<div class="container">
    		<div id="homepage-text-wrapper" class="row">
    			<div class="col-xs-12 col-sm-12 col-md-12">
	    			<?php print render($page['homepage_text']); ?>
	    		</div>
	    	</div>
    	</div>	
    </section>
...
<section class="featured-products">
  ...
  <?php if (!empty($page['featured_products'])): ?>
